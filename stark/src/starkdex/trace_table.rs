...
fn test_trace_table() {
    ...
    for i in 0..trace_table.num_rows() {
        ...
        let state_transition__merkle_update__prev_authentication__hashes__ec_subset_sum__bit_neg =
            FieldElement::ZERO;
        let state_transition__merkle_update__prev_authentication__hashes__ec_subset_sum__bit_neg_neg =
            FieldElement::ONE
            ...
            assert_eq!(
                &hash_pool__hash__ec_subset_sum__bit
                    * (&trace_table[(8, i + 2)] + &trace_table[(8, i + 6)])
                    - &trace_table[(8, i + 1)]
                        * (&trace_table[(8, i + 0)] - &trace_table[(8, i + 4)]),
                FieldElement::ZERO
            );
        }
        if (i % 4 == 0) && !(i % 1024 == 1024 / 256 * 255) {
        ...
        if (i % 2048 == 0) && !(false) {
            assert_eq!(
                &trace_table[(8, i + 0)] - &shift_point.x,
                FieldElement::ZERO
            );
        }
        if (i % 2048 == 0) && !(false) {
        ...
        if (true) && !(i % 256 == 255) {
            assert_eq!(
                &state_transition__merkle_update__prev_authentication__hashes__ec_subset_sum__bit_neg_neg
        ...
        if (i % 256 == 251) && !(false) {
            assert_eq!(trace_table[(7, i + 0)].clone(), FieldElement::ZERO);
        }
        if (i % 256 == 255) && !(false) {
            assert_eq!(trace_table[(7, i + 0)].clone(), FieldElement::ZERO);
        }
            ...
            assert_eq!(
                &state_transition__merkle_update__new_authentication__hashes__ec_subset_sum__bit
                    * (&trace_table[(5, i + 0)] - &merkle_hash_points__y)
                    - &trace_table[(6, i + 0)]
                        * (&trace_table[(4, i + 0)] - &merkle_hash_points__x),
                FieldElement::ZERO
            );
        }
        if (true) && !(i % 256 == 255) {
            ...
            assert_eq!(
                &state_transition__merkle_update__new_authentication__hashes__ec_subset_sum__bit
                    * (&trace_table[(5, i + 0)] + &trace_table[(5, i + 1)])
                    - &trace_table[(6, i + 0)]
                        * (&trace_table[(4, i + 0)] - &trace_table[(4, i + 1)]),
                FieldElement::ZERO
            );
        }
        if (true) && !(i % 256 == 255) {
        ...
        if (i % 512 == 0) && !(false) {
            assert_eq!(
                &trace_table[(4, i + 0)] - &shift_point.x,
                FieldElement::ZERO
            );
        }
        if (i % 512 == 0) && !(false) {
            assert_eq!(
                &trace_table[(5, i + 0)] - &shift_point.y,
                FieldElement::ZERO
            );
        }
        if (i % 512 == 0) && !(i % 16384 == 16384 / 32 * 31 || i % 16384 == 16384 / 16 * 15) {
